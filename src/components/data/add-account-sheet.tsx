        ...
        <div className="mt-4 space-y-4 px-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[var(--way-stone)] border border-[var(--way-shadow)] rounded-lg px-3 py-2 text-base text-[var(--way-text)] placeholder:text-[var(--way-muted)] outline-none focus:border-[var(--way-gold)]"
              autoFocus
            />
            <button
              onClick={handleAdd}
